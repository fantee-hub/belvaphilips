  ...
  return (
    <div className="w-full">
      {!isSubmitted ? (
        ...
        <motion.div
          className="flex flex-col justify-center space-x-3 max-w-[594px] md:h-[71px] py-5 px-4 border-[0.5px] border-[#C9C9C9] rounded-[16px]"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
        >
          <div className="flex items-start gap-3">
            ...
            <p className="text-[#444444]  -mt-1 flex-1">
